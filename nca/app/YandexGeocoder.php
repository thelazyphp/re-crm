...
class YandexGeocoder
{
    ...
    {
        $cache = YandexGeocoderCache::whereGeocode($geocode)->whereKind($kind)->first();
     ...
     */
    public static function translateAddress($geocode, $kind = null)
    {
        $response = static::request($geocode, $kind);
        ...
        if (
            ...
            $response = static::request($lng.','.$lat, 'metro');
