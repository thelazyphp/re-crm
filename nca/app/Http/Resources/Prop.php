...
class Prop extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            'id' => $this->id,
            'flags' => new Flags($this->flags),
            'type' => new PropComponent($this->type),
            'inventory_number' => $this->inventory_number,
            'address' => new Address($this->address),
            'function' => new PropComponent($this->function),
            ...
            'proportion_before_transaction' => $this->proportion_before_transaction,
            'proportion_after_transaction' => $this->proportion_after_transaction,
            'rooms' => $this->rooms,
            'floor' => $this->floor,
